...
<ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
  ...
  <li ><a href="index_user.php"><span>Task Manager</span></a></li>
  <li class="active"><a href="forumuser.php"><span>Forum</span></a></li>
    ...
    <div class="container">
        ...
        <div class="form-popup" id="comment-form">
            ...
            <form action="" method="post">
                ...
                <input type="text" name="name" placeholder="<?php echo $_SESSION['user_name'] ?>"  value="<?php echo $_SESSION['user_name'] ?>" readonly>
